...
export default function DealershipCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setGrossSalesToCustomers(initialValues.grossSalesToCustomers);
    setGrossProfits(initialValues.grossProfits);
    setOurProfitFromThem(initialValues.ourProfitFromThem);
    setTheirProfitMarginDollars(initialValues.theirProfitMarginDollars);
    setTheirProfitMarginPercent(initialValues.theirProfitMarginPercent);
    setLifetimeTotalTransactions(initialValues.lifetimeTotalTransactions);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDealership.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DealershipCreateForm")}
      {...rest}
    >
      <TextField
